...
export default function FeelingsScreen() {
  ...
  if (submitted) {
    return (
      <div className="flex flex-col items-center justify-center min-h-screen px-6 text-center">
        ...
        <p className="text-gray-500">Waiting for your partner to select their feelings...</p>
      </div>
    );
  }
  ...
  return (
    <div className="flex flex-col min-h-screen px-6 py-10">
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-gray-900 mb-2">How did you feel?</h1>
        <p className="text-gray-500">Select the emotions you felt during the incident. No need to explain why.</p>
      </div>
