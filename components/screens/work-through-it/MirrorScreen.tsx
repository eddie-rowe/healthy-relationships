  ...
  if (mirror && confirmed === null) {
    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-screen px-6 text-center">
        <h1 className="text-2xl font-bold text-gray-900 mb-2">Does this capture what you said?</h1>
        <div className="bg-violet-50 border border-violet-100 rounded-2xl p-5 mb-8 max-w-sm w-full">
          <p className="text-gray-900 italic">&quot;{mirror}&quot;</p>
        </div>
  ...
  if (confirmed === false || !mirror) {
    return (
      <div className="flex flex-col min-h-screen px-6 py-10">
        <div className="mb-6">
          <h1 className="text-2xl font-bold text-gray-900 mb-2">Mirror what you heard</h1>
          <p className="text-gray-500">Reflect your partner&apos;s words back to them</p>
          {confirmed === false && (
            <p className="text-amber-600 text-sm mt-2">Your partner felt that wasn&apos;t quite right. Try again.</p>
          )}
        </div>
