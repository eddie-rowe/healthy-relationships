...
export default function EmpathizeScreen({ empathy, confirmed }: {
  ...
  if (empathy && confirmed === null) {
    return (
      <div className="flex flex-col items-center justify-center min-h-screen px-6 text-center">
        <h1 className="text-2xl font-bold text-gray-900 mb-2">Does this resonate?</h1>
        <p className="text-gray-500 mb-6">Your partner imagines how you feel:</p>
        <div className="bg-violet-50 border border-violet-100 rounded-2xl p-5 mb-8 max-w-sm w-full">
          <p className="text-gray-900 italic">&quot;I imagine you might be feeling {empathy}&quot;</p>
        </div>
  ...
  return (
    <div className="flex flex-col min-h-screen px-6 py-10">
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-gray-900 mb-2">Empathize</h1>
        <p className="text-gray-500">Imagine what your partner might be feeling</p>
        {confirmed === false && (
          <p className="text-amber-600 text-sm mt-2">That didn&apos;t quite resonate. Try again.</p>
        )}
      </div>
